...
> Agentbase is the effect commit layer for AI agents — it commits irreversible actions exactly once wherever the provider deduplicates, and survives a crash in the middle. This package is the **protocol-level** integration; the [`@agentbase/sdk`](../sdk) package is the code-level integration. Same gate behind both.
