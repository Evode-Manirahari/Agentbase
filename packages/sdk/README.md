...
> Agentbase is the effect commit layer for AI agents — it commits irreversible actions exactly once wherever the provider deduplicates, and survives a crash in the middle. This SDK is what makes that true for *your* agent.
