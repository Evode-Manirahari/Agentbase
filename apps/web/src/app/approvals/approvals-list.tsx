    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        ...
        <input
          ...
          required
          disabled={disabled}
          className="rounded-md border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-2 text-sm w-[220px] focus:outline-none focus:border-[var(--color-accent)] disabled:opacity-40"
        />
        <input
          type="text"
          name="notes"
